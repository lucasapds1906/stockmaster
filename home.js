...
function atualizarTabela() {
    fetch('https://stockmasteratt-default-rtdb.firebaseio.com/produtos.json')
        .then(response => {
            if (!response.ok) {
...
// FUNÇÃO QUE ORDENA ARRAY DE PRODUTOS COM BASE NOS IDS E RENDERIZA NO HTML
...
// BUSCAR O PROXIMO ID LIVRE
function buscarProximoID() {
    return fetch('https://stockmasteratt-default-rtdb.firebaseio.com/produtos.json')
...
function excluirProduto(id) {
    ...
    fetch(`https://stockmasteratt-default-rtdb.firebaseio.com/produtos/${id}.json`, {
        method: 'DELETE'
    })
        .then(response => {
            if (!response.ok) {
